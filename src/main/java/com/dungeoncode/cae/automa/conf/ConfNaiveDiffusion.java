...
import com.dungeoncode.cae.automa.rule.RuleNaiveDiffusion;
...
import static com.dungeoncode.cae.core.Dimension.TWO;
...
public class ConfNaiveDiffusion extends AbstractConfiguration<BooleanCell, BooleanState> {
    ...
    public ConfNaiveDiffusion() {
        super(22, null, List.of(new RuleNaiveDiffusion()), TWO);
    }
