...
import com.dungeoncode.ca.automa.rules.RuleTubeWorms;
 ...
 * @see RuleTubeWorms
 */
public class ConfTubeWorms extends AbstractConfiguration<BooleanCell, BooleanState> {
     ...
     * (50% probability) in the state and random timer values (0-3), and applies the {@link RuleTubeWorms} for state
     * updates.
     *
