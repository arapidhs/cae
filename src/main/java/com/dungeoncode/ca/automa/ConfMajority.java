...
//                Tag.VOTING,        // New tag for rules that use voting mechanisms
//
//                // Behavior Types
//                Tag.STRUCTURED,    // Creates organized domains
//                Tag.STABLE,        // Forms stable boundaries
//                Tag.DOMAIN,        // New tag for rules that create distinct domains
//
//                // Source Types
//                Tag.BOOK,
//                Tag.CLASSIC
...
//    /**
//     * Configures the specified {@link Automaton} with a grid, rule, and interval for the MAJORITY automaton.
...
//        config.put(CONF_RULES, new RuleMajority());
