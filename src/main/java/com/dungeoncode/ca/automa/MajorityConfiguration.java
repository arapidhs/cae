...
import com.dungeoncode.ca.automa.rules.MajorityRule;
 ...
 */
public class MajorityConfiguration extends AbstractConfiguration<BooleanCell, BooleanState> {
     ...
     * {@link MajorityRule} for state updates.
     *
    ...
    public void configure(Automa<BooleanCell, BooleanState> automa, int width, int height, long intervalMillis) {
        ...
        config.put("rule", new MajorityRule());
