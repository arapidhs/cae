...
import com.dungeoncode.ca.automa.rules.TrianglesRule;
 ...
 */
public class TrianglesConfiguration extends AbstractConfiguration<BooleanCell, BooleanState> {
     ...
     * with a 3x3 central region of active cells, and applies the {@link TrianglesRule} for state updates.
     *
    ...
    public void configure(Automa<BooleanCell, BooleanState> automa, int width, int height, long intervalMillis) {
        ...
        config.put("rule", new TrianglesRule());
