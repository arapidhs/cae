...
import com.dungeoncode.ca.automa.rules.TimeTunnelRule;
import com.dungeoncode.ca.core.AbstractConfiguration;
import com.dungeoncode.ca.core.Automa;
import com.dungeoncode.ca.core.Grid;
import com.dungeoncode.ca.core.impl.BooleanCell;
import com.dungeoncode.ca.core.impl.BooleanState;
import com.dungeoncode.ca.core.impl.CentralSquareWithEchoInitializer;
 ...
 * cells, with all other cells inactive, using {@link CentralSquareWithEchoInitializer}. This configuration is inspired by the
 * TIME-TUNNEL rule described in Chapter 6, Section 6.2 of <i>Cellular Automata Machines: A New Environment for
 * Modeling</i>.
 *
 * @see TimeTunnelRule
 * @see CentralSquareWithEchoInitializer
 */
public class TimeTunnelConfiguration extends AbstractConfiguration<BooleanCell, BooleanState> {
     ...
     */
    public TimeTunnelConfiguration() {
        super(
                "Time Tunnel Waves",
     ...
     * Creates a {@link Grid} with the given dimensions, initialized by {@link CentralSquareWithEchoInitializer}
     * with a centered 6x6 square of active cells, and applies the {@link TimeTunnelRule} for state updates.
     *
    ...
    public void configure(Automa<BooleanCell, BooleanState> automa, int width, int height, long intervalMillis) {
        ...
        Grid<BooleanCell, BooleanState> grid = new Grid<>(width, height, new CentralSquareWithEchoInitializer(3));
        config.put("grid", grid);
        config.put("rule", new TimeTunnelRule());
