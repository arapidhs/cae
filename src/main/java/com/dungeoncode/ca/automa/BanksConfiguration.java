...
import com.dungeoncode.ca.automa.rules.BanksRule;
 ...
 */
public class BanksConfiguration extends AbstractConfiguration<BooleanCell, BooleanState> {
     ...
     * {@link BanksRule} for state updates.
     *
