...
import com.dungeoncode.ca.automa.rules.RandomAnnealRule;
 ...
 * {@link PrimevalSoupBooleanInitializer}. This configuration is inspired by the RAND-ANNEAL rule described in
 * Chapter 8, Section 8.3 of <i>Cellular Automata Machines: A New Environment for Modeling</i>.
 *
 * @see RandomAnnealRule
 * @see PrimevalSoupBooleanInitializer
 */
public class RandomAnnealConfiguration extends AbstractConfiguration<BooleanCell, BooleanState> {
     ...
     */
    public RandomAnnealConfiguration() {
        super(
     ...
     * applies the {@link RandomAnnealRule} for state updates.
     *
    ...
    public void configure(Automa<BooleanCell, BooleanState> automa, int width, int height, long intervalMillis) {
        ...
        config.put("rule", new RandomAnnealRule());
