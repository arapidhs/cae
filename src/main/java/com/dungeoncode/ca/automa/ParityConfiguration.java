...
import com.dungeoncode.ca.automa.rules.ParityRule;
import com.dungeoncode.ca.core.AbstractConfiguration;
import com.dungeoncode.ca.core.Automa;
import com.dungeoncode.ca.core.Grid;
import com.dungeoncode.ca.core.impl.*;
 ...
 */
public class ParityConfiguration extends AbstractConfiguration<BooleanCell, BooleanState> {
     ...
     * with a random distribution of live and dead cells, and applies the {@link ParityRule} for state updates.
     *
    ...
    public void configure(Automa<BooleanCell, BooleanState> automa, int width, int height, long intervalMillis) {
        ...
        config.put("rule", new ParityRule());
