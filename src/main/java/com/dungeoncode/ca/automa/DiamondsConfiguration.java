...
import com.dungeoncode.ca.automa.rules.DiamondsRule;
 ...
 */
public class DiamondsConfiguration extends AbstractConfiguration<BooleanCell, BooleanState> {
     ...
     * with a 3x3 central region of active cells, and applies the {@link DiamondsRule} for state updates.
     *
    ...
    public void configure(Automa<BooleanCell, BooleanState> automa, int width, int height, long intervalMillis) {
        ...
        config.put("rule", new DiamondsRule());
