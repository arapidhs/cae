 ...
 */
public class GameOfLifeWithEchoConfiguration extends AbstractConfiguration<BooleanCell, BooleanState> {
     ...
     */
    public GameOfLifeWithEchoConfiguration() {
        super(
     ...
     * the {@link GameOfLifeEchoRule} to manage state updates and echo effects.
     *
    ...
    public void configure(Automa<BooleanCell, BooleanState> automa, int width, int height, long intervalMillis) {
        ...
        config.put(CONF_RULE, new GameOfLifeEchoRule(false));
