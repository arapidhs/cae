...
import com.dungeoncode.ca.automa.rules.HGlassRule;
 ...
 */
public class HGlassConfiguration extends AbstractConfiguration<BooleanCell, BooleanState> {
     ...
     * with a random distribution of live and dead cells, and applies the {@link HGlassRule} for state updates.
     *
    ...
    public void configure(Automa<BooleanCell, BooleanState> automa, int width, int height, long intervalMillis) {
        ...
        config.put(CONF_RULE, new HGlassRule());
